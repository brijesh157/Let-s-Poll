    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navigationView.setNavigationItemSelectedListener {
            when(it.itemId){
                ...
                R.id.feedback->{
                    var browserIntent =  Intent(Intent.ACTION_VIEW, Uri.parse("https://docs.google.com/forms/d/e/1FAIpQLSfrh3sDIHYDxJg9h181ARHsV_wwMuV6uijJS8HbdIwqie_3Jg/viewform?usp=sf_link"));
